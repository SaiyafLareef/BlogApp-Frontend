...
export const blogSchema = z.object({
  ...
  excerpt: z.string().min(10, 'Summary must be at least 10 characters').max(300, 'Summary is too long'),
  ...
  imageUrl: z.string().url('Must be a valid image URL (or upload a local file)').min(1, 'Cover image is required')
})
